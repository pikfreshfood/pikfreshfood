        ...
        <aside class="admin-sidebar" id="adminSidebar">
            ...
            <nav class="menu">
                ...
                @if($adminUser && $adminUser->hasAdminPermission('users'))
                    <a href="{{ route('admin.users') }}" class="{{ request()->routeIs('admin.users*') ? 'active' : '' }}"><i class="menu-icon"><svg viewBox="0 0 24 24" aria-hidden="true"><circle cx="9" cy="8" r="3"></circle><path d="M3 20a6 6 0 0 1 12 0"></path><path d="M16 11a3 3 0 1 0 0-6"></path><path d="M17 14a5 5 0 0 1 4 5"></path></svg></i><span>Manage Users</span></a>
                @endif
                @if($adminUser && $adminUser->hasAdminPermission('admins'))
                    <a href="{{ route('admin.admins') }}" class="{{ request()->routeIs('admin.admins*') ? 'active' : '' }}"><i class="menu-icon"><svg viewBox="0 0 24 24" aria-hidden="true"><circle cx="9" cy="8" r="3"></circle><path d="M3 20a6 6 0 0 1 12 0"></path><path d="M16 11h5"></path><path d="M18.5 8.5v5"></path></svg></i><span>Manage Admins</span></a>
                @endif
